import Subcubic.Lemma5_11.BluishI

/-! Cases (3.2.2.3.1)--(3.2.2.3.2) of Lemma 5.11. -/

namespace Subcubic

variable {V : Type*} [Fintype V] {G : SimpleGraph V}

structure Lemma5_11JConfiguration (C : MatchingCutColoring G)
    (a b c d e f : V) extends
    Lemma5_11JKConfiguration C a b c d e f where
  hja : G.Adj j a

theorem lemma5_11_jk_cases
    ...
    (Q : Lemma5_11JKConfiguration C a b c d e f) :
  ...
  · by_cases hka : G.Adj Q.k a
    · let Q' : Lemma5_11JKConfiguration C a b c d e f := {
        toLemma5_11IConfiguration := Q.toLemma5_11IConfiguration
        j := Q.k
        k := Q.j
        hj := Q.hk
        hk := Q.hj
