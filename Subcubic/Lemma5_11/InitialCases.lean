import Subcubic.Lemma5_11.Isolated
import Subcubic.Lemma5_6

/-!
# Lemma 5.11: Cases (1), (2), and setup for Case (3)
...
structure Lemma5_11Case3Configuration (C : MatchingCutColoring G)
    (a b c d e f : V) where
  g : V
  h : V
  hg : C.color g = .bluish
...
theorem lemma5_11_cases1_and_2_setup3
  ...
  · by_cases hge : G.Adj g e
    ...
    · by_cases hgf : G.Adj g f
      · have hfdV : f ≠ d := hv (x := (5 : Fin 6)) (y := 3) (by decide)
        ...
        · by_cases hhb : G.Adj h b
          ...
          · by_cases hha : G.Adj h a
            ...
            · left
              exact lemma5_11_flip_bc_isolates_ef C
      ...
      · exact Or.inl (lemma5_11_flip_bc_isolates_ef C hp ha hb hc hd he hf
