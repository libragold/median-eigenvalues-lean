import Subcubic.Lemma5_11.SetupI
import Subcubic.Lemma5_11.InlinePath4
import Subcubic.Lemma5_9

/-!
# Lemma 5.11, Case (3.2.1)
...
theorem lemma5_11_case_3_2_1
  ...
  · obtain ⟨M, hflip⟩ := hflip
    ...
    · have hmulti : 2 ≤ fourVertexCrossEdgeCount G c Q.i j k := by
        ...
        omega
      have hout := lemma5_2 D c Q.i j k Q.hci hcD hiD
        hjk hjD hkD hmulti
      exact (noD (hout.elim (HasReachableNegativeReduction.of_current_ntr D)
        (HasReachableNegativeReduction.of_current_ce D))).elim
    ...
    · have hjg : j ≠ Q.g := color_ne hj Q.hg (by decide)
      ...
      · rw [hgD] at hgBluish
        contradiction
      · exact (noD (HasReachableNegativeReduction.of_current_ce D hceD)).elim
    ...
    · exact (noD (lemma5_9 D hinduced heD hfD hgD hbD hcD hiD hjD hkD
    ...
    · push Not at hNoRedAtK
      ...
      exact (noD (lemma5_10_inline D hsub heD hfD hgD hbD hcD hiD hjD hkD hl hm)).elim
