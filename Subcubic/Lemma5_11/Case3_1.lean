import Subcubic.Lemma5_11.InitialCases
import Subcubic.NegativeTailReducerWitnesses

/-! Case (3.1) of Lemma 5.11. -/

namespace Subcubic

variable {V : Type*} [Fintype V] {G : SimpleGraph V}

structure Lemma5_11Case3_2Configuration (C : MatchingCutColoring G)
    (a b c d e f : V) extends
    Lemma5_11Case3Configuration C a b c d e f where
  hga : ¬ G.Adj g a
  hhf : ¬ G.Adj h f

theorem lemma5_11_case_3_1
    (C : MatchingCutColoring G) {a b c d e f : V}
    (hpath : FormsInducedPath6 G a b c d e f)
    (ha : C.color a = .red) (hb : C.color b = .red)
    (hc : C.color c = .blue) (hd : C.color d = .blue)
    (he : C.color e = .red) (hf : C.color f = .red)
    (Q : Lemma5_11Case3Configuration C a b c d e f) :
    HasReachableNegativeReduction C ∨
      Nonempty (Lemma5_11Case3_2Configuration C a b c d e f) := by
  classical
