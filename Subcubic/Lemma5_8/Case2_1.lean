...
theorem lemma5_8_case2_1
  ...
  · subst q
    ...
    apply containsNegativeAi C he hf ha hb hr hs hg hh hc hd hp
  ...
  · by_cases hrs : r = s
    · subst s
      apply containsNegativeAi C ha hb he hf hp hq hc hd hg hh hr
        hab hap hha.symm hbq hbc hef hde.symm her hfg hfs hcd hgh
      simp only [List.nodup_cons, List.mem_cons, not_or, List.nodup_nil]
        at hcycleNodup hpout hqout hrout ⊢
      grind
    · apply containsNegativeAj C ha hb he hf hp hq hc hd hg hh hs hr
        hab hap hha.symm hbq hbc hef hde.symm her hfg hfs hcd hgh
      simp only [List.nodup_cons, List.mem_cons, not_or, List.nodup_nil]
