import Subcubic.Lemma5_13.InlinePath3
import Subcubic.Lemma5_13.Basic
import Subcubic.Lemma4_12.Case3Shared

/-!
# Cases using the inlined Lemma 5.12 step
...
theorem lemma5_13_case2_setup
    ...
    (hga : g ≠ a) (hgb : g ≠ b) :
    ∃ R : Lemma5_13Case2Configuration C a b c d,
  ...
  exact ⟨⟨Q, g, h, hg, hh, heg, hgh, hga, hgb⟩, rfl⟩
...
theorem lemma5_13_case2_flip_path
    ...
    (Q : Lemma5_13Case2Configuration C a b c d) :
    HasReachableNegativeReduction C ∨
      Nonempty (NegativeOneFlipPath3Configuration C) := by
  classical
