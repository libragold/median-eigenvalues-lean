import Subcubic.Lemma4_10.CaseBlueI

/-! Cases (3.2.2.1)--(3.2.2.3) of Lemma 4.10. -/

namespace Subcubic

variable {V : Type*} [Fintype V] {G : SimpleGraph V}

structure Lemma4_10JKConfiguration (C : MatchingCutColoring G)
    (a b c d e f : V) extends
    Lemma4_10IConfiguration C a b c d e f where
  j : V
  k : V
  hj : C.color j = .bluish
  hk : C.color k = .bluish
...
theorem lemma4_10_bluish_i_cases
    ...
    HasReachableReduction C ∨
      Nonempty (Lemma4_10JKConfiguration C a b c d e f) := by
  classical
  ...
  · have choose : ∃ j, G.Adj Q.i j ∧ j ≠ c ∧ j ≠ d := by
    ...
    · left
      ...
      apply containsPositiveP C Q.hi hb he hj hc hd Q.hg Q.hh
  ...
  · by_cases hih : G.Adj Q.i Q.h
    · have choose : ∃ j, G.Adj Q.i j ∧ j ≠ c ∧ j ≠ Q.h := by
      ...
      apply Or.inl
      apply HasReachableReduction.of_current_ptr C
      apply containsPositiveM C Q.hi he hj Q.hh hc hd
        hij hih Q.hci.symm Q.heh hde.symm hcd hie hid hej
        (by simpa using nonedge 4 2 (by native_decide))
      simp [color_ne Q.hi he (by decide), color_ne Q.hi hj (by decide),
        color_ne Q.hi Q.hh (by decide), color_ne Q.hi hc (by decide),
        color_ne Q.hi hd (by decide), color_ne he hj (by decide),
        color_ne he Q.hh (by decide), color_ne he hc (by decide),
        color_ne he hd (by decide), hjh, color_ne hj hc (by decide),
        color_ne hj hd (by decide), color_ne Q.hh hc (by decide),
        color_ne Q.hh hd (by decide),
        hcdV]
